...
%% Parameters
n_chunks = 20; % how many pre-reimplant and post-reimplant chunks?
chunk_duration = 3600; % how long should each chunk be?
dead_time = 1e4; % ignore the first 10,000 seconds at the start and end of each file
min_distance = 3600; % this is how far away different chunks should be from each other and from events
